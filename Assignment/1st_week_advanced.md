...
> **🧚 Q. 이 연구는 새로운 교육 프로그램이 학생들의 수학 성적에 미치는 영향을 조사하였습니다. 연구자는 50명의 학생을 두 그룹으로 나누어, 한 그룹에는 새로운 교육 프로그램을 적용하고(실험군), 다른 그룹에는 기존 교육 방법을 유지하였습니다(통제군). 8주 후, 두 그룹의 수학 시험 점수를 비교한 결과는 다음과 같습니다.

그룹	평균 점수	표준편차
실험군	85.4	4.2
통제군	82.1	5.1
t-검정을 실시한 결과, p값은 0.03으로 나타났습니다. 연구자는 유의수준(α)을 0.05로 설정하였습니다.

질문:

이 연구에서 귀무가설과 대립가설은 무엇인가요?
p값과 유의수준을 고려할 때, 귀무가설을 기각해야 하나요?
이 결과를 바탕으로 새로운 교육 프로그램이 기존 방법보다 효과적이라고 결론지을 수 있나요?
p값이 0.03이라는 것은 무엇을 의미하나요?
이 연구의 결과를 해석할 때 주의해야 할 점은 무엇인가요?**   
